    ...
    return (
      <div className='designHeader'>
        <div className='headerSpace logoDesign'>
          <img
            className='logo'
            src={require('../../img/aiflix-logo.png')}
            alt='logo'
            onClick={() => navegar('/')}
          />
        </div>
        ...
        <div className='headerSpace linksDesign'>
          {window.location.pathname === '/login' && (
            <div className='link' onClick={() => navegar('/login')}>
              <b>Login</b>
            </div>
          )}
          {window.location.pathname !== '/login' && (
          ...
          {window.location.pathname === '/register' && (
            <div className='link' onClick={() => navegar('/register')}>
              <b>Registro</b>
            </div>
          )}
          {window.location.pathname !== '/register' && (
        ...
        {window.location.pathname !== '/display' && (
          <div className='designHeader'>
            ...
            <div className='headerSpace linksDesign'>
              ...
              {props.credentials?.usuario.rol === true &&
              ...
              {window.location.pathname === '/film' && (
                <div className='link' onClick={() => navegar('/film')}>
                  <b>Películas</b>
                </div>
              )}
              {window.location.pathname !== '/film' && (
        ...
        {window.location.pathname === '/display' && (
          <div className='headerSpace logoDesign'>
            <img
              ...
              src={require('../../img/volver.png')}
              alt='logo'
              onClick={() => navegar('/film')}
            />
          </div>
        )}
      </div>
