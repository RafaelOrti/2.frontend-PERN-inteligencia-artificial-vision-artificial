            ...
            <div className='results__wrapper'>
              ...
              <div className='results__wrapper__bar0'>
                ...
                <div className='results__wrapper__bar'>
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.angry * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.disgusted * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.fearful * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.happy * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.neutral * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.sad * 540) }} />
                  <div className='barraResults' style={{ width: 1 + (results[0].expressions.surprised * 540) }} />
                </div>
              </div>
            </div>
            )}
