  ...
  return (
    <div className='designProfile'>
      <div className='designProfileHalf profileLeft'>
        <div className='profileField'><b>Nombre:<input type='text' name='nombre' id='nombre' title='nombre' placeholder={props.credentials.usuario.nombre} autoComplete='off' onChange={(e) => { rellenarDatos(e) }} /></b></div>
        <div className='profileField'><b>Apellidos:</b><input type='text' name='apellido' id='apellido' title='apellido' placeholder={props.credentials.usuario.apellido} autoComplete='off' onChange={(e) => { rellenarDatos(e) }} /></div>
        ...
        <div className='profileField'><b>Nickname:</b><input type='text' name='nickname' id='nickname' title='nickname' placeholder={props.credentials.usuario.nickname} autoComplete='off' onChange={(e) => { rellenarDatos(e) }} /></div>
        <div className='profileField'><b>Edad:</b><input type='text' name='edad' id='edad' title='edad' placeholder={props.credentials.usuario.edad} autoComplete='off' onChange={(e) => { rellenarDatos(e) }} /></div>
        <div className='profileField'><b>Password:</b><input type='text' name='password' id='password' title='password' placeholder='*****' autoComplete='off' onChange={(e) => { rellenarDatos(e) }} /></div>
